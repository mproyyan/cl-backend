...
function addColor(input, arr, container) {
...
addColor(bestInput, bestColors, bestColorsContainer);
addColor(avoidInput, avoidColors, avoidColorsContainer);
...
recommendBtn.addEventListener("click", async () => {
    ...
    try {
        ...
        resultsContainer.innerHTML = "Request failed";
    }
        ...
        const itemCards = Object.entries(items)
          ...
          <div class="item-card">
            ...
            <div class="item-info">
              ...
              <div>${item.color}</div>
              <div class="item-hex">${item.hex}</div>
            </div>
          </div>
        `;
            })
